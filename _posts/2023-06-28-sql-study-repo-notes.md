---
layout: post
title: "SQL_Study 개발 기록"
date: 2023-06-28 14:40:30 +0900
categories: ["repository"]
tags: ["sql-study"]
summary: "studying_SQL"
repo: "SQL_Study"
repo_url: "https://github.com/byStander9/SQL_Study"
generated: true
ai_enriched: false
---

SQL_Study 레포를 기준으로 README와 파일 구조를 자동으로 확인해 정리한 개발 기록이다.
이 글은 레포가 업데이트되면 GitHub Actions를 통해 다시 생성될 수 있다.

## 레포 개요

- 레포 주소: <https://github.com/byStander9/SQL_Study>
- 기본 브랜치: `main`
- 주요 언어: 미지정
- 최근 업데이트: 2023.06.28
- 설명: studying_SQL
...
언어와 의존성 파일 기준으로 뚜렷한 기술 스택을 판단하기는 어려웠다.

## 우선 확인할 파일

- `README.md`: 프로젝트 소개와 사용법을 담은 문서
- `prac_0626.sql`: 구현 흐름을 확인할 수 있는 코드/설정 파일
- `prac_0627.sql`: 구현 흐름을 확인할 수 있는 코드/설정 파일
