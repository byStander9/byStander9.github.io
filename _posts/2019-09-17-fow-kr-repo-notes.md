...
layout: post
title: "fow.kr 개발 기록"
date: 2019-09-17 16:37:42 +0900
categories: ["repository", "javascript"]
tags: ["javascript", "fow-kr"]
summary: "op.gg와 같은 사이트 개발"
repo: "fow.kr"
repo_url: "https://github.com/byStander9/fow.kr"
generated: true
ai_enriched: false
---

fow.kr 레포를 기준으로 README와 파일 구조를 자동으로 확인해 정리한 개발 기록이다.
이 글은 레포가 업데이트되면 GitHub Actions를 통해 다시 생성될 수 있다.

## 레포 개요

- 레포 주소: <https://github.com/byStander9/fow.kr>
- 기본 브랜치: `master`
- 주요 언어: JavaScript
- 최근 업데이트: 2019.09.17
- 설명: op.gg와 같은 사이트 개발
...
- `firstSending.js`: 구현 흐름을 확인할 수 있는 코드/설정 파일
- `fow.kr_main.html`: 구현 흐름을 확인할 수 있는 코드/설정 파일
- `jsonParse.js`: 구현 흐름을 확인할 수 있는 코드/설정 파일
