---
layout: post
title: "pyscript 개발 기록"
date: 2023-12-02 20:09:19 +0900
categories: ["repository", "html", "python"]
tags: ["html", "python", "pyscript"]
summary: "studying pyscript"
repo: "pyscript"
repo_url: "https://github.com/byStander9/pyscript"
generated: true
ai_enriched: false
---

pyscript 레포를 기준으로 README와 파일 구조를 자동으로 확인해 정리한 개발 기록이다.
이 글은 레포가 업데이트되면 GitHub Actions를 통해 다시 생성될 수 있다.

## 레포 개요

- 레포 주소: <https://github.com/byStander9/pyscript>
- 기본 브랜치: `main`
- 주요 언어: HTML
- 최근 업데이트: 2023.12.02
- 설명: studying pyscript
...
- `code/hello.py`: 구현 흐름을 확인할 수 있는 코드/설정 파일
- `code/index.html`: 구현 흐름을 확인할 수 있는 코드/설정 파일
