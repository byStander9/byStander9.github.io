---
layout: post
title: "JSP_Study 개발 기록"
date: 2023-07-03 12:13:38 +0900
categories: ["repository", "java"]
tags: ["java", "jsp-study"]
summary: "Studying JSP"
repo: "JSP_Study"
repo_url: "https://github.com/byStander9/JSP_Study"
generated: true
ai_enriched: false
---

JSP_Study 레포를 기준으로 README와 파일 구조를 자동으로 확인해 정리한 개발 기록이다.
이 글은 레포가 업데이트되면 GitHub Actions를 통해 다시 생성될 수 있다.

## 레포 개요

- 레포 주소: <https://github.com/byStander9/JSP_Study>
- 기본 브랜치: `main`
- 주요 언어: Java
- 최근 업데이트: 2023.07.03
- 설명: Studying JSP
...
- `WebContent/Jsp_ex1/Login_Form.html`: 구현 흐름을 확인할 수 있는 코드/설정 파일
- `WebContent/Jsp_ex1/YourName.html`: 구현 흐름을 확인할 수 있는 코드/설정 파일
