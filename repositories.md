...
<div class="archive-page">
  <p class="archive-intro">
    ...
    Pinned는 GitHub 프로필에 pin한 레포를 자동으로 가져오며, Other는 메인/글 목록에서 제외하고 <a href="{{ '/other/' | relative_url }}">Other</a>에서만 보이도록 설정한다.
  </p>

  <div class="repo-preference-panel">
    <div>
      <strong>Repository Display</strong>
      <p>Other 선택값은 이 브라우저에 먼저 저장된다. PR 생성 버튼을 누르면 GitHub 로그인 후 블로그 설정 변경 PR을 만든다.</p>
    </div>
